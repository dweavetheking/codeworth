...
export async function writeMarkdown(result: ScanResult, outDir: string, filename: string = 'codeworth.report.md') {
    ...
    if (result.maintainability) {
        const lowest = result.maintainability.breakdown.reduce((prev, curr) =>
